...
const Projects = () => {
  ...
  return (
    <div id='projects'>
      <section className="flex flex-col gap-y-8 py-16 px-3 md:px-3 sm:py-16 lg:py-24">
        <motion.h1 
        ...
        <motion.div 
          className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10 justify-items-center w-full max-w-6xl mx-auto"
